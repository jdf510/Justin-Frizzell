...
fin3.close();
    ...
    cout << "\nPlayers are ranked according to their Glicko ratings." << endl;
...
//  this finds RMSE of all systems on both test sets
    cout << "\nSystem\tRMSE set#1\tRMSE set#2" << endl;
...
//  this finds Binomial devience of all systems on both test sets
    ...
    //uncomment this to include optimisation tests, can take up to an hour to run.
