...
void GlickoUpdate(vector<Player>&,vector<string>, int, int); // will play Glicko games, month by month
...
double phi(double); // used for Gaussian varient of Elo. credit http://www.johndcook.com/cpp_phi.html
double s2d(const string&); // converts strings to doubles
