...
Player::Player(string a)
  {
	...
	EloL = 1000;
	EloG = 1000;
	kFactor = 37; // change this to use another k-factor, but also change the corrosponding value in the clearPlayers function.
    //Glicko
	t = 1;
    R = 1500;
    RD = 350;
...
/*
 //to find a players convergence for ELo
        ...
        for(int i=0; i < players.size(); i++)
            {
                ...
                players[i].setkFactor(37); // remember to change this if chaging k-factor
...
/*
 //to find a players convergence for Glicko
